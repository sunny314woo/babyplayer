...
export LOCAL_PREPROCESSED_AUDIO_CACHE_DIRECTORY="${LOCAL_PREPROCESSED_AUDIO_CACHE_DIRECTORY:-${SERVER_DIR}/.cache/preprocessed-audio}"
export LOCAL_MEDIA_CONTENT_HASH_CACHE_DIRECTORY="${LOCAL_MEDIA_CONTENT_HASH_CACHE_DIRECTORY:-${SERVER_DIR}/.cache/media-content-hashes}"
